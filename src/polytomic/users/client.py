...
class UsersClient:
    ...
    def update(
        ...
        *,
        ...
        _response = self._raw_client.update(
            org_id, id, email=email, role=role, role_ids=role_ids, request_options=request_options
        )
        return _response.data
    ...
    def remove(self, org_id: str, id: str, *, request_options: typing.Optional[RequestOptions] = None) -> UserEnvelope:
        ...
        """
        _response = self._raw_client.remove(org_id, id, request_options=request_options)
        return _response.data
...
class AsyncUsersClient:
    ...
    async def remove(
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.remove(org_id, id, request_options=request_options)
        return _response.data
