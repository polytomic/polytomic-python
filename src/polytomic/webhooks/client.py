...
class WebhooksClient:
    ...
    def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> WebhookListEnvelope:
        """
...
class AsyncWebhooksClient:
    ...
    async def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> WebhookListEnvelope:
        """
        Webooks can be set up using the webhook API endpoints. Currently, only one
        webhook may be created per organization. The webhook will be called for events
        in that organization.
