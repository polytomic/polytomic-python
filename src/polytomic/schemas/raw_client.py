...
class RawSchemasClient:
    ...
    def upsert_field(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(connection_id)}/schemas/{encode_path_param(schema_id)}/fields",
            method="POST",
            json={
                "fields": convert_and_respect_annotation_metadata(
                    object_=fields, annotation=typing.Sequence[UserFieldRequest], direction="write"
                ),
            },
            headers={
    ...
    def set_primary_keys(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(connection_id)}/schemas/{encode_path_param(schema_id)}/primary_keys",
            method="PUT",
            json={
                "fields": convert_and_respect_annotation_metadata(
    ...
    def refresh(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/schemas/refresh",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
            },
    ...
    def get_status(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/schemas/status",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/schemas/{encode_path_param(schema_id)}",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_records(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/schemas/{encode_path_param(schema_id)}/records",
            method="GET",
            request_options=request_options,
        )
        try:
