    ...
    def post(
        ...
        *,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(V2GetEnrichmentInputFieldsResponseEnvelope, _response.json())  # type: ignore
    ...
    def preview(
        ...
        *,
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        ---
        from polytomic import CreateModelRequest
        from polytomic.client import Polytomic
        ...
        _response = self._client_wrapper.httpx_client.request(
            "POST",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/model-preview"),
            params=jsonable_encoder(
                remove_none_from_dict(
                    {
                        "async": async_,
