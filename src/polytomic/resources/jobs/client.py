...
class JobsClient:
    ...
    def get(self, id: str, type: str) -> JobResponseEnvelope:
        """
        Parameters:
            - id: str.
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"api/jobs/{type}/{id}"),
...
class AsyncJobsClient:
    ...
    async def get(self, id: str, type: str) -> JobResponseEnvelope:
        """
        Parameters:
            - id: str.
