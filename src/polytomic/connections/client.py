...
class ConnectionsClient:
    ...
    def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> ConnectionListResponseEnvelope:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
...
class AsyncConnectionsClient:
    ...
    async def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> ConnectionListResponseEnvelope:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        await client.connections.list_()
        """
        _response = await self._client_wrapper.httpx_client.request(
            "api/connections", method="GET", request_options=request_options
        )
