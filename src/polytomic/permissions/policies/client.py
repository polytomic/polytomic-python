...
class PoliciesClient:
    ...
    def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> ListPoliciesResponseEnvelope:
        """
        Parameters
        ----------
        ...
        client.permissions.policies.list_()
        """
...
class AsyncPoliciesClient:
    ...
    async def list_(self, *, request_options: typing.Optional[RequestOptions] = None) -> ListPoliciesResponseEnvelope:
        """
        Parameters
        ----------
        request_options : typing.Optional[RequestOptions]
        ...
        await client.permissions.policies.list_()
        """
