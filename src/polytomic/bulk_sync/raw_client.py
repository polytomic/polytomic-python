...
class RawBulkSyncClient:
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                "active": active,
                "additional_schedules": convert_and_respect_annotation_metadata(
                    object_=additional_schedules,
                    annotation=typing.Sequence[BulkSyncAdditionalScheduleRequest],
                    direction="write",
                ),
                ...
                "default_schedule": convert_and_respect_annotation_metadata(
                    object_=default_schedule, annotation=BulkSyncDefaultScheduleRequest, direction="write"
                ),
                ...
                "schemas": convert_and_respect_annotation_metadata(
                    object_=schemas, annotation=typing.Sequence[CreateBulkSyncRequestSchemasItem], direction="write"
                ),
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/bulk/syncs/{encode_path_param(id)}",
            method="GET",
            params={
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "resync_concurrency_limit": resync_concurrency_limit,
                "schemas": convert_and_respect_annotation_metadata(
                    object_=schemas, annotation=typing.Sequence[UpdateBulkSyncRequestSchemasItem], direction="write"
                ),
                "source_configuration": source_configuration,
                "source_connection_id": source_connection_id,
            },
    ...
    def activate(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/bulk/syncs/{encode_path_param(id)}/activate",
            method="POST",
            json={
                "active": active,
            },
    ...
    def cancel(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/bulk/syncs/{encode_path_param(id)}/cancel",
            method="POST",
            headers={
                "Idempotency-Key": str(idempotency_key) if idempotency_key is not None else None,
            },
    ...
    def get_status(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/bulk/syncs/{encode_path_param(id)}/status",
            method="GET",
            request_options=request_options,
        )
        try:
    ...
    def get_source(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/bulksync/source",
            method="GET",
            params={
    ...
    def get_destination(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"api/connections/{encode_path_param(id)}/bulksync/target",
            method="GET",
            request_options=request_options,
        )
        try:
