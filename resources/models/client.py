...
class ModelsClient:
    ...
    def api_v_2_list_models(self) -> V2ModelListResponseEnvelope:
        """
        ...
        client.models.api_v_2_list_models()
        """
    ...
    def api_v_2_get_model(self, id: str) -> V2ModelResponseEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        client.models.api_v_2_get_model(
    ...
    def api_v_2_remove_model(self, id: str) -> None:
        """
        Parameters:
            - id: str.
        ---
        ...
        client.models.api_v_2_remove_model(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
...
class AsyncModelsClient:
    ...
    async def api_v_2_list_models(self) -> V2ModelListResponseEnvelope:
        """
        ...
        await client.models.api_v_2_list_models()
        """
    ...
    async def api_v_2_create_model(
        self,
        *,
        additional_fields: typing.Optional[typing.List[V2ModelFieldRequest]] = OMIT,
        configuration: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
    ...
    async def api_v_2_get_model(self, id: str) -> V2ModelResponseEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        await client.models.api_v_2_get_model(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_remove_model(self, id: str) -> None:
        """
        Parameters:
            - id: str.
        ---
        ...
        await client.models.api_v_2_remove_model(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_update_model(
        self,
        id: str,
        *,
        additional_fields: typing.Optional[typing.List[V2ModelFieldRequest]] = OMIT,
