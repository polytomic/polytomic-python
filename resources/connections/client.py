...
class ConnectionsClient:
    ...
    def api_v_2_get_connection_types(self) -> V2ConnectionTypeResponseEnvelope:
        """
        ...
        client.connections.api_v_2_get_connection_types()
        """
    ...
    def api_v_2_list_connections(self) -> V2ConnectionListResponseEnvelope:
        """
        from polytomic.client import PolytomicApi
        ...
        client.connections.api_v_2_list_connections()
        """
        _response = self._client_wrapper.httpx_client.request(
            "GET",
    ...
    def api_v_2_get_connection(self, id: str) -> V2ConnectionResponseEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        client.connections.api_v_2_get_connection(
    ...
    def api_v_2_remove_connection(self, id: str, *, force: typing.Optional[bool] = None) -> None:
        """
        Parameters:
            - id: str.
        ...
        client.connections.api_v_2_remove_connection(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def api_v_2_get_connection_source(self, id: str) -> V2GetConnectionMetaEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        client.connections.api_v_2_get_connection_source(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def api_v_2_get_connection_source_fields(
        ...
        client.connections.api_v_2_get_connection_source_fields(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
    ...
    def api_v_2_get_connection_target(
        ...
        client.connections.api_v_2_get_connection_target(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = self._client_wrapper.httpx_client.request(
    ...
    def api_v_2_get_connection_target_fields(
        ...
        client.connections.api_v_2_get_connection_target_fields(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
...
class AsyncConnectionsClient:
    ...
    async def api_v_2_get_connection_types(self) -> V2ConnectionTypeResponseEnvelope:
        """
        ...
        await client.connections.api_v_2_get_connection_types()
        """
    ...
    async def api_v_2_list_connections(self) -> V2ConnectionListResponseEnvelope:
        """
        from polytomic.client import AsyncPolytomicApi
        ...
        await client.connections.api_v_2_list_connections()
        """
        _response = await self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "api/connections"),
    ...
    async def api_v_2_create_connection(
        self,
        *,
        configuration: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
        name: str,
    ...
    async def api_v_2_get_connection(self, id: str) -> V2ConnectionResponseEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        await client.connections.api_v_2_get_connection(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_remove_connection(self, id: str, *, force: typing.Optional[bool] = None) -> None:
        """
        Parameters:
            - id: str.
        ...
        await client.connections.api_v_2_remove_connection(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_update_connection(
        self,
        id: str,
        *,
        configuration: typing.Optional[typing.Dict[str, typing.Any]] = OMIT,
    ...
    async def api_v_2_get_connection_source(self, id: str) -> V2GetConnectionMetaEnvelope:
        """
        Parameters:
            - id: str.
        ---
        ...
        await client.connections.api_v_2_get_connection_source(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_get_connection_source_fields(
        self, id: str, *, query: typing.Optional[typing.Dict[str, typing.Any]] = OMIT
    ) -> V2ModelFieldResponse:
        """
        Parameters:
        ...
        await client.connections.api_v_2_get_connection_source_fields(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _request: typing.Dict[str, typing.Any] = {}
    ...
    async def api_v_2_get_connection_target(
        self, id: str, *, type: typing.Optional[str] = None, search: typing.Optional[str] = None
    ) -> V2GetConnectionMetaEnvelope:
        """
        Parameters:
        ...
        await client.connections.api_v_2_get_connection_target(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
        )
        """
        _response = await self._client_wrapper.httpx_client.request(
    ...
    async def api_v_2_get_connection_target_fields(
        self, id: str, *, refresh: typing.Optional[bool] = OMIT, target: str
    ) -> V2TargetResponseEnvelope:
        """
        Parameters:
        ...
        await client.connections.api_v_2_get_connection_target_fields(
            id="248df4b7-aa70-47b8-a036-33ac447e668d",
            target="database.table",
        )
        """
