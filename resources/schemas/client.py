...
class SchemasClient:
    ...
    def api_v_3_get_schema_records(self, connection_id: str, schema_id: str) -> V3SchemaRecordsResponseEnvelope:
        """
        Parameters:
            - connection_id: str.
        ...
        client.schemas.api_v_3_get_schema_records(
...
class AsyncSchemasClient:
    ...
    async def api_v_3_get_schema_records(self, connection_id: str, schema_id: str) -> V3SchemaRecordsResponseEnvelope:
        """
        Parameters:
            - connection_id: str.
        ...
        await client.schemas.api_v_3_get_schema_records(
            connection_id="248df4b7-aa70-47b8-a036-33ac447e668d",
            schema_id="schema-id",
        )
        """
